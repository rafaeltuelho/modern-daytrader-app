...
## DayTrader Frontend Context

The DayTrader frontend is a modern React 18 application consuming the Quarkus backend API.

### Technology Stack
- **Framework**: React 18 with TypeScript
- **Styling**: Tailwind CSS with custom theme
- **State Management**: React Context API or Redux (as per specifications)
...
- **Authentication**: JWT token management, login/logout flows
- **Account Management**: User profile, account settings
- **Trading**: Buy/sell operations, order placement
- **Market Data**: Real-time quotes, market information
- **Portfolio**: Holdings view, performance tracking
- **Orders**: Order history, order status tracking

### Key Pages/Components
- **Login/Register**: Authentication flows with JWT
- **Dashboard**: Overview of portfolio, market data, recent trades
- **Trading**: Buy/sell interface with market data
- **Portfolio**: Holdings view with performance metrics
